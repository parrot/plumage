...
=head1 Add a New Project Action
...
Add an entry for the new action to the C<SYNOPSIS>, and then add a section
for the new action with more details in the C<DESCRIPTION> section of the
POD.
